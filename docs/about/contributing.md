...
If you would like to get involved with the Subcommittee, contact [Rick Graves](mailto:rick.graves.1@us.af.mil) or [David Loda](#).
...
and is created based on the source code found in the repository located <https://github.com/aiaa-deic/deco>.
...
to raise an [issue](https://github.com/aiaa-deic/deco/issues) in the repository
...
As above, if you have any problems, please raise an [issue](https://github.com/aiaa-deic/deco/issues).
...
The node package manager `npm` is similar to the Python program `pip`.
...
- raise an [issue](https://github.com/aiaa-deic/deco/issues) in the repository and put `@jdhaines` somewhere in the text.
